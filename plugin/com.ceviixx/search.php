...
$parser->add_argument('type', $help='movie|tvshow|...', $action='get_val');
$parser->add_argument('lang', $help='enu|cht|...', $action='get_val');
$parser->add_argument("input", $help="json string", $action='get_val');
$parser->add_argument("limit", $help="result count", $action='get_val');
$parser->add_argument("allowguess", $help="", $action='get_val');
...
$type = $args['type'];
$test = json_decode($args['input'], true);
$title = $test['title'];
...
$url = 'http://10.0.0.2:8080/?type='.$type.'&title='.$title.'&lang='.$lang.'&limit='.$limit;
// https://itunes-api.ceviixx.site/?type=movie&title=Harry+Potter&lang=ger&limit=1
